  ...
  if (!(data.groupID && data.message)) {
    return {
      ...
      body: JSON.stringify({
        ...
        message:
          'Post data should contain valid "groupID", "message" parameters.',
      }),
    };
  }
    ...
    if ((err as Error).name === "ResourceNotFoundException") {
      ...
      return {
        ...
        body: JSON.stringify({
          ...
          message: `Group with id "${data.groupID}" does not exist or was deleted before.`,
        }),
      };
    }
  }
